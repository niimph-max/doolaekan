...
export interface AppState {
  ...
  loadOk: boolean;
  onboarded: boolean;
  /** เพิ่งลบบัญชีไปเมื่อครู่ — ค้างไว้บนจอเพื่อบอกผลว่าเกิดอะไรขึ้นจริง
   *  ถ้าเด้งกลับหน้าใส่อีเมลเฉยๆ ผู้ใช้จะไม่รู้เลยว่าลบสำเร็จหรือกดพลาด
   *  'full' = ลบข้อมูลและบัญชีเข้าระบบครบ · 'data' = ลบข้อมูลแล้วแต่อีเมลยังอยู่ */
  deleted?: 'full' | 'data';
  tab: Tab;
  actorName: string;
  bigText: boolean;
