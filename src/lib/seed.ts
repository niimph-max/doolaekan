...
/** หัวข้อที่ใช้บ่อยในชีต "จดอาการ"
 *
 *  ชีตนี้ถูกใช้จริงกว้างกว่าชื่อของมัน — ไม่ได้จดแต่อาการ แต่จดเหตุการณ์
 *  ประจำวันของคนไข้ด้วย เช่นวันนี้ไปฉีดยา วันนี้ไปหาหมอ ซึ่งเดิมจะขึ้นชื่อว่า
 *  "บันทึกเพิ่มเติม" ทุกอัน แล้วหาไม่เจอเวลาย้อนดู หัวข้อจึงเป็นของที่ใส่ได้
 *  แต่ไม่บังคับ */
export const NOTE_HEAD_CHIPS = [
  'ฉีดยา', 'ไปหาหมอ', 'ทำแผล', 'กายภาพ', 'เจาะเลือด', 'รับยา',
];
