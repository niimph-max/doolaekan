...
/** เรื่องที่ไปทำมาที่โรงพยาบาล — อยู่คู่กับชนิดเอกสารในชีต "พบหมอ / เอกสาร"
 *
 *  ไปหาหมอทีหนึ่งมักได้ทั้งสองอย่างมาพร้อมกัน คือเรื่องที่ไปทำ กับกระดาษที่ถือ
 *  กลับบ้าน จึงอยู่ที่เดียวกัน ไม่ต้องจดสองที่ และบางครั้งไปทำแล้วไม่มีกระดาษ
 *  ติดมือกลับมาเลย ซึ่งก็ยังต้องจดได้ */
export const VISIT_CHIPS = [
  'ไปหาหมอ', 'ฉีดยา', 'ทำแผล', 'กายภาพ', 'เจาะเลือด', 'รับยา',
];
...
/** ชนิดการออกกำลังกายที่ใช้บ่อย — แตะเลือกแทนพิมพ์ พิมพ์เองก็ได้
 *  ชนิดที่เลือกไว้คือกุญแจที่ใช้ดึง "ครั้งก่อนทำอะไรไว้" ขึ้นมาให้ดู */
export const EXERCISE_CHIPS = [
  'ยิม', 'เดิน', 'วิ่ง', 'ปั่นจักรยาน', 'ว่ายน้ำ', 'โยคะ', 'ยืดเส้น',
];

/** มื้ออาหาร */
export const MEAL_CHIPS = ['เช้า', 'กลางวัน', 'เย็น', 'ว่าง'];

/** วัคซีนที่คนไทยฉีดกันบ่อย — แตะเลือกแทนพิมพ์ พิมพ์เองก็ได้ */
export const VACCINE_CHIPS = [
  'ไข้หวัดใหญ่', 'โควิด-19', 'บาดทะยัก', 'ปอดอักเสบ', 'งูสวัด',
  'ไวรัสตับอักเสบบี', 'คอตีบ-บาดทะยัก (dT)', 'พิษสุนัขบ้า',
];

/** เข็มที่เท่าไหร่ */
export const DOSE_CHIPS = ['เข็ม 1', 'เข็ม 2', 'เข็ม 3', 'กระตุ้น', 'ประจำปี'];
